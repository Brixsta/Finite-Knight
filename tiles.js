...
export class Door {
  ...
  detectPlayerCollision () {
    if(index.player.x + 20 >= this.x && index.player.x <= this.x + this.width && index.player.y + 20 >= this.y && index.player.y <= this.y + this.height && this.readyToOpen) {
      this.opened = true;
  ...
  removeKey () {
    ...
    keys.forEach(key => key.style.opacity = .4);
...
export class Torch {
  ...
  draw() {
    ...
    index.ctx.drawImage(this.image, this.sx, this.sy, index.global.cellSize, index.global.cellSize, this.x, this.y, index.global.cellSize, index.global.cellSize)
  }
...
export class Stairs {
  ...
  detectPlayerCollision () {
    if(index.player.x + 20 >= this.x && index.player.x <= this.x + this.width && index.player.y + 20 >= this.y && index.player.y + 20 <= this.y + this.height && !this.victory) {
